    ...
    data=[
        {
            ...
            "input": {
                "text_": "Barack Obama was the 44th president of the United States."
            },
            "output": {
        ...
        {
            "input": {
                "text_": "Apple's latest product, the iPhone 15, was released in September 2023."
            },
            "output": {
                "skill_0": "\n- Apple (company)\n- iPhone 15 (product)\n- September 2023 (date)"
            },
...
def test_llm_linear_skillset():
    ...
    pd.testing.assert_frame_equal(
        InternalDataFrame.from_records(
            [
                # FIRST ROW
                {
